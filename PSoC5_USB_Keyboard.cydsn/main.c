...
const uint16 ASCII_ToScanCode[] = {0x02C, 0x11E, 0x11F, 0x120, 0x121, 0x122, 0x123, 0x124, 0x125, 0x126, 0x134, 0x133, 0x036, 0x02d, 0x037, 0x038,
...
void In_EP(void) {
    ...
    if (UART_GetRxBufferSize()) {
        ...
        if (c == 0x00) {
            ...
            uint16 key = ASCII_ToScanCode[c-0x20];
